...
exports.LAYOUT_KINDS = ['camera', 'jib', 'ob_truck', 'desk', 'screen', 'speaker', 'riser', 'podium', 'gimbal', 'remote_head', 'micro_stand', 'action_cam', 'ptz', 'tele_lens', 'box_lens', 'mirrorless', 'control_room', 'rack', 'generic'];
